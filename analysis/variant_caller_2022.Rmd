...
```{r}
seqdata_tsv_name=c("data/Consensus_Data/novogene_lane28/for_export/sample1/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane28/for_export/sample2/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane28/for_export/sample3/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane28/for_export/sample5/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane28/for_export/sample7/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane28/for_export/sample8/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane28/for_export/sample9/duplex/duplex_sorted_filtered.tsv.gz")

outdir=c("data/Consensus_Data/novogene_lane28/for_export/sample1/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane28/for_export/sample2/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane28/for_export/sample3/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane28/for_export/sample5/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane28/for_export/sample7/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane28/for_export/sample8/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane28/for_export/sample9/duplex/variant_caller_outputs")
```
...
for(i in c(1:5)){
  ...
  input_df_nol298l=read.csv(paste("data/Consensus_Data/novogene_lane29a/",sample,"/nol298l/sscs/variant_caller_outputs/variants_unique_ann.csv",sep=""))
  input_df_l298l=read.csv(paste("data/Consensus_Data/novogene_lane29a/",sample,"/l298l/sscs/variant_caller_outputs/variants_unique_ann.csv",sep=""))
  
  output_df=add_l298l(input_df_nol298l,input_df_l298l)
  output_df=output_df[, !names(output_df) == "X", drop = FALSE]

  write.csv(output_df,
            paste("data/Consensus_Data/novogene_lane29a/",sample,"/sscs/variant_caller_outputs/variants_unique_ann.csv",sep = ""),row.names = F)  
}
```
