...
```{r}
seqdata_tsv_name=c("data/Consensus_Data/novogene_lane29b/for_export/sample3/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample6/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample7/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample8/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample9/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample3/l298l/duplex/duplex_sorted_filtered.tsv.gz")

outdir=c("data/Consensus_Data/novogene_lane29b/for_export/sample3/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample6/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample7/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample8/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample9/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane29b/for_export/sample3/l298l/duplex/variant_caller_outputs")

seqdata_tsv_name=c("data/Consensus_Data/novogene_lane29a/sample2/nol298l/sscs/sscs_sorted_filtered.tsv.gz")
outdir=c("data/Consensus_Data/novogene_lane29a/sample2/nol298l/sscs/variant_caller_outputs")
```
...
for(i in c(1:1)){
  ...
  input_df_nol298l=read.csv(paste("data/Consensus_Data/novogene_lane29b/for_export/",sample,"/nol298l/duplex/variant_caller_outputs/variants_unique_ann.csv",sep=""))
  input_df_l298l=read.csv(paste("data/Consensus_Data/novogene_lane29b/for_export/",sample,"/l298l/duplex/variant_caller_outputs/variants_unique_ann.csv",sep=""))
  
  output_df=add_l298l(input_df_nol298l,input_df_l298l)
  output_df=output_df[, !names(output_df) == "X", drop = FALSE]

  write.csv(output_df,
            paste("data/Consensus_Data/novogene_lane29b/for_export/",sample,"/duplex/variant_caller_outputs/variants_unique_ann.csv",sep = ""),row.names = F)  
}
```
