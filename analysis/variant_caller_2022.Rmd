...
```{r}
seqdata_tsv_name=c("data/Consensus_Data/novogene_lane15/sample_7/duplex/duplex_sorted_filtered.tsv.gz",
                   "data/Consensus_Data/novogene_lane15/sample_7/sscs/sscs_sorted_filtered.tsv.gz")

outdir=c("data/Consensus_Data/novogene_lane15/sample_7/duplex/variant_caller_outputs",
                   "data/Consensus_Data/novogene_lane15/sample_7/sscs/variant_caller_outputs")
```
