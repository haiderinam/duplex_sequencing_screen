...
kr2d0=kr2d0%>%filter(protein_start%in%c(322:394),consequence_terms%in%"missense_variant",ct>=5)
...
kr3d6=kr3d6%>%filter(protein_start%in%c(394:465),consequence_terms%in%"missense_variant",ct>=5)
heatmap_plotting_function(kr3d6,394,465,fill_name = "Net growth rate")


kr4d0=read.csv("data/Consensus_Data/novogene_lane29a/sample16/sscs/variant_caller_outputs/variants_unique_ann.csv")
kr4d0=kr4d0%>%filter(protein_start%in%c(465:512),consequence_terms%in%"missense_variant",ct>=5)
