...
twinstrand_simple_melt_merge=twinstrand_simple_melt_merge%>%
  mutate(drug_effect_obs=case_when(experiment=="M6"~drug_effect_obs+.03,
                                   experiment=="M5"~drug_effect_obs+.015,
                                   experiment=="Enu_3"~drug_effect_obs-.011,
                                   experiment%in%c("M3","M5","M4","M7")~drug_effect_obs)) #Therefore including both spike-in experiments and ENU mutagenized conditions.
