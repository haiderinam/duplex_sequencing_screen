...
deviations_forexport=deviations%>%ungroup()%>%dplyr::select(mutant,percent_error,count_mean_obs,count_sd_obs,count_mean_pred=sd_mean_model)
write.csv(deviations_forexport,"deviations.csv")
```
