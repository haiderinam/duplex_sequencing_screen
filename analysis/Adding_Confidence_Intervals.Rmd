---
title: "Adding_Confidence_Intervals"
author: "Haider Inam"
date: "6/15/2025"
...
```
This RMD file should serve to generate processed versions of all the data that goes into Figure 3 of the paper.
...
a=m3m6d0%>%filter(experiment%in%"1:5,000")
...
ggsave("output/spikeins/maf_fig_raw_081525.pdf",width=6,height=3,units="in",useDingbats=F)
...
ggsave("output/spikeins/pooled_growth_fig_raw_061725.pdf",width=6,height=3,units="in",useDingbats=F)
