...
twinstrand_simple=twinstrand_simple%>%select("mutant","experiment","Spike_in_freq","time_point","totalmutant")
...
# write.csv(twinstrand_maf_merge,"twinstrand_maf_merge_csv")
# write.csv(twinstrand_simple_melt_merge,"twinstrand_simple_melt_merge_csv")
```
