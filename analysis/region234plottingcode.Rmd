...
tsi_il3=tsi_il3%>%mutate(netgr_obs_mean=mean(c(netgr_obs_screen1,netgr_obs_screen2)))
...
tsi_imatinib=tsi_imatinib%>%mutate(netgr_obs_mean=mean(c(netgr_obs_screen1,netgr_obs_screen2)))
...
```{r}
imatinib_all=read.csv("output/ABLEnrichmentScreens/ABL_Region234_Comparisons/ABLfullkinase_allconditions_growthrates_12.19.24.csv")
