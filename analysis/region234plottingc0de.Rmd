...
heatmap_plotting_function(imatinib_all%>%filter(!score.IL3.2%in%"NaN"),240,512,fill_variable = "score.IL3.2",fill_name = "Enrichment Score")
...
heatmap_plotting_function(imatinib_all%>%filter(!score.imat.mid.2%in%"NaN"),240,512,fill_variable = "score.imat.mid.2",fill_name = "Enrichment Score")
...
ggsave("output/ABLEnrichmentScreens/ABL_Region234_Comparisons/baf3_imatinib_heatmap_1200nM_score.pdf",width=16,height=4,units="in",useDingbats=F)


a=il3_1_vsil3_2_all%>%filter(protein_start%in%392)
b=il3_1_vsil3_2_all%>%filter(protein_start%in%395)
