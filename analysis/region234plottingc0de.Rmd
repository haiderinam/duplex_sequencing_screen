...
r1=read.csv("output/ABLEnrichmentScreens/ABL_Region1_Lane18_Comparisons/cross-replicate/baf3_IL3_rep1vsrep2_ft/screen_comparison_baf3_IL3_low_rep1vsrep2ft.csv")
...
write.csv(imatinib_all,"output/ABLEnrichmentScreens/ABL_Region234_Comparisons/imatinib_combined_growthrates_1.2.23.csv")
...
source("code/plotting/heatmap_plotting_function.R")
heatmap_plotting_function(imatinib_all%>%filter(!netgr_IL3.1%in%"NaN"),240,512,fill_variable = "netgr_IL3.2",fill_name = "Net growth rate")
ggsave("output/ABLEnrichmentScreens/ABL_Region234_Comparisons/imatinib_heatmap_il3.pdf",width=16,height=4,units="in",useDingbats=F)
...
ggsave("output/ABLEnrichmentScreens/ABL_Region234_Comparisons/imatinib_heatmap_300nM.pdf",width=16,height=4,units="in",useDingbats=F)
