...
ggsave(paste(dirname,"1a.baf3_imatinib_heatmap_netgr_",dose,"_",seqtech,"_",date,".pdf",sep=""),width=16,height=4,units="in",useDingbats=F)
...
ggsave(paste(dirname,"1b.baf3_imatinib_heatmap_netgr_corrected_",dose,"_",seqtech,"_",date,".pdf",sep=""),width=16,height=4,units="in",useDingbats=F)
...
ggplot(standards%>%filter(!protein_start%in%c(354:361)),aes(x=.055-drug_effect,y=netgr_obs_mean,label=species))+
  ...
  geom_abline(linetype="dashed")+
  cleanup
ggsave(paste(dirname,"4a.baf3_imatinib_mutantstandards_netgr_",dose,"_",seqtech,"_",date,".pdf",sep=""),width=3,height = 3,units="in",useDingbats=F)
...
ggplot(standards%>%filter(!protein_start%in%c(354:361)),aes(x=.055-drug_effect,y=netgr_obs_mean_corr,label=species))+
  ...
  geom_abline(linetype="dashed")+
  cleanup
ggsave(paste(dirname,"4b.baf3_imatinib_mutantstandards_netgr_corrected_",dose,"_",seqtech,"_",date,".pdf",sep=""),width=3,height = 3,units="in",useDingbats=F)
...
ggsave(paste(dirname,"6a.baf3_imatinib_pre-existingALL_netgr_",dose,"_",seqtech,"_",date,".pdf",sep=""),width=4,height=4,units="in",useDingbats=F)
