...
seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane28c", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)
...
for(j in 10:length(seqdata_tsv_name)){
# for(j in 1:1)){
