...
```{r}
# The following script creates a list of the main directory of all samples in a for a sequencing lane 
seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane29a", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane18", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane27b", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane28b", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane29b", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

# seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane29a", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
# outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane28", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane23", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)
...
seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane29c/ABL", pattern = "^duplex_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("duplex_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane29c/ABL", pattern = "^duplex_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("duplex_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane28b/for_export", pattern = "^duplex_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("duplex_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)

seqdata_tsv_name=list.files("data/Consensus_Data/novogene_lane27b/for_export", pattern = "^sscs_sorted_filtered\\.tsv\\.gz$", recursive = TRUE, full.names = TRUE)
outdir <- gsub("sscs_sorted_filtered\\.tsv\\.gz$", "variant_caller_outputs", seqdata_tsv_name)
...
for(i in c(1:length(l298l.samples))){
  ...
  input_df_nol298l=read.csv(paste("data/Consensus_Data/novogene_lane29c/ABL/",sample,"/nol298l/sscs/variant_caller_outputs/variants_unique_ann.csv",sep=""))
  input_df_l298l=read.csv(paste("data/Consensus_Data/novogene_lane29c/ABL/",sample,"/l298l/sscs/variant_caller_outputs/variants_unique_ann.csv",sep=""))
  ...
  # for(i in c(1:21)){
  # sample="sample1"
  # input_df_nol298l=read.csv(paste("data/Consensus_Data/novogene_lane18/",sample,"/nol298l/sscs/variant_caller_outputs/variants_unique_ann.csv",sep=""))
  # input_df_l298l=read.csv(paste("data/Consensus_Data/novogene_lane18/",sample,"/l298l/sscs/variant_caller_outputs/variants_unique_ann.csv",sep=""))
  
  output_df=add_l298l(input_df_nol298l,input_df_l298l)
  output_df=output_df[, !names(output_df) == "X", drop = FALSE]

  write.csv(output_df,
            paste("data/Consensus_Data/novogene_lane29c/ABL/",sample,"/sscs/variant_caller_outputs/variants_unique_ann.csv",sep = ""),row.names = F)  
}
```
