...
ggplot(smdata,aes(x=netgr_obs_screen1,y=netgr_obs_screen2))+geom_point()
...
ggplot(smdata,aes(x=netgr_obs_screen1,y=netgr_obs_screen2))+
  ...
  scale_x_continuous("Net growth rate R1")+
  scale_y_continuous("Net growth rate R2")
ggsave("output/BE_SM_Plots/correlation_sm.pdf",width=4,height = 4,units = "in",useDingbats=F)
