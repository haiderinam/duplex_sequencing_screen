...
imatD2=merge_samples("Novogene_lane14/sample12/sscs","Novogene_lane15/sample_6/sscs")
...
scores_all=merge(il3D0.D2%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),il3D2.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),suffixes = c(".il3d0.d2",".il3d2.d4"))
#Second, adding Imat D0 D2 to dataframe
scores_all=merge(scores_all,imatD0.D2%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"))
scores_all=scores_all%>%rename(score.imatd0.d2=score)
#Third, adding Imat D2 D4 to dataframe
scores_all=merge(scores_all,imatD2.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"))
scores_all=scores_all%>%rename(score.imatd2.d4=score)
#Fourth, adding IL3 D4 D0 to dataframe
scores_all=merge(scores_all,il3D0.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"))
scores_all=scores_all%>%rename(score.il3d0.d4=score)
#Fifth, adding Imatinib D4 D0 to dataframe
scores_all=merge(scores_all,imatD0.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"))
