...
ggplot(resmuts_merged%>%filter(!protein_start%in%317),aes(x=netgr_pred_model,y=score.imatd0.d6-score.il3d0.d6,label=species))+geom_text()
ggplot(resmuts_merged%>%filter(!protein_start%in%317),aes(x=netgr_pred_model,y=netgr_obs.imatd0.d6-netgr_obs.il3d0.d6,label=species))+geom_text()+geom_abline()
