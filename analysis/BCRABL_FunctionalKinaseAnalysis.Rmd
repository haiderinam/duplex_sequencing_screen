...
il3D0_simple=il3D0%>%dplyr::select(alt_start_pos,protein_start,ref,alt,ref_aa,alt_aa,consequence_terms,ct,depth,maf,totalmutant)
...
il3D2_simple=il3D2%>%dplyr::select(alt_start_pos,protein_start,ref,alt,ref_aa,alt_aa,consequence_terms,ct,depth,maf,totalmutant)
...
imatD2_simple=imatD2%>%dplyr::select(alt_start_pos,protein_start,ref,alt,ref_aa,alt_aa,consequence_terms,ct,depth,maf,totalmutant)
...
il3D4_simple=il3D4%>%dplyr::select(alt_start_pos,protein_start,ref,alt,ref_aa,alt_aa,consequence_terms,ct,depth,maf,totalmutant)
...
imatD4_simple=imatD4%>%dplyr::select(alt_start_pos,protein_start,ref,alt,ref_aa,alt_aa,consequence_terms,ct,depth,maf,totalmutant)
...
il3D2.D4[il3D2.D4$ct.y%in%NA,"ct.y"]=0
...
ggplot(il3D0.D2.merge,aes(x=protein_start,y=alt_aa))+
  ...
  ylab("Mutant Amino Acid")
# ggsave("BCRABL_imatinib_D2_gray.pdf",height=6,width=24,units="in",useDingbats=F)



####Plotting Imatinib D4 D2 scores vs Imatinib D2 D0 scores
#First merging IL3 D0 D2 to IL3 D2 D4
scores_all=merge(il3D0.D2%>%dplyr::select(-ct.x,-depth.x,-maf.x,-totalmutant.x,-ct.y,-depth.y,-maf.y,-totalmutant.y),il3D2.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-totalmutant.x,-ct.y,-depth.y,-maf.y,-totalmutant.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),suffixes = c(".il3d0.d2",".il3d2.d4"),all = T)
#Second, adding Imat D0 D2 to dataframe
scores_all=merge(scores_all,imatD0.D2%>%dplyr::select(-ct.x,-depth.x,-maf.x,-totalmutant.x,-ct.y,-depth.y,-maf.y,-totalmutant.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),all = T)
scores_all=scores_all%>%rename(score.imatd0.d2=score,netgr_obs.imatd0.d2=netgr_obs)
#Third, adding Imat D2 D4 to dataframe
scores_all=merge(scores_all,imatD2.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-totalmutant.x,-ct.y,-depth.y,-maf.y,-totalmutant.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),all = T)
scores_all=scores_all%>%rename(score.imatd2.d4=score,netgr_obs.imatd2.d4=netgr_obs)
#Fourth, adding IL3 D4 D0 to dataframe
scores_all=merge(scores_all,il3D0.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-totalmutant.x,-ct.y,-depth.y,-maf.y,-totalmutant.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),all = T)
scores_all=scores_all%>%rename(score.il3d0.d4=score,netgr_obs.il3d0.d4=netgr_obs)
#Fifth, adding Imatinib D4 D0 to dataframe
scores_all=merge(scores_all,imatD0.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-totalmutant.x,-ct.y,-depth.y,-maf.y,-totalmutant.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),all = T)
...
il3D0=merge_samples("Novogene_lane14/Sample10_combined/duplex","Novogene_lane15/sample_3/duplex")
# il3D0=merge_samples("Novogene_lane14/Sample10_combined/duplex","Novogene_lane13/sample7/duplex")
# a=il3D0%>%filter(protein_start%in%c(315:316))
il3D0=merge_samples(il3D0,"Novogene_lane14/sample11/duplex")
# il3D0=merge_samples(il3D0,"Novogene_lane13/sample7/duplex")
...
il3D2=merge_samples("Novogene_lane13/Sample9/duplex","Novogene_lane13/Sample10/duplex")
il3D2=merge_samples(il3D2,"Novogene_lane15/Sample_4/duplex")
il3D2=il3D2%>%
  rowwise()%>%
  mutate(ref_aa=strsplit(amino_acids,"/")[[1]][1],
         alt_aa=strsplit(amino_acids,"/")[[1]][2])
...
# imatD2=read.csv("data/Consensus_Data/Novogene_lane14/sample12/variant_caller_outputs/variants_unique_ann.csv",stringsAsFactors = F)
imatD2=merge_samples("Novogene_lane14/sample12/duplex","Novogene_lane15/sample_6/duplex")
# imatD2=merge_samples(imatD2,"Novogene_lane15/Sample4")
imatD2=imatD2%>%
  rowwise()%>%
  mutate(ref_aa=strsplit(amino_acids,"/")[[1]][1],
...
il3D4=read.csv("data/Consensus_Data/novogene_lane15/sample_5/duplex/variant_caller_outputs/variants_unique_ann.csv")
# imatD2=merge_samples(imatD2,"Novogene_lane15/Sample4")
il3D4=il3D4%>%
  rowwise()%>%
  mutate(ref_aa=strsplit(amino_acids,"/")[[1]][1],
         alt_aa=strsplit(amino_acids,"/")[[1]][2])
il3D4=il3D4%>%mutate(maf=ct/depth)
il3D4_simple=il3D4%>%dplyr::select(alt_start_pos,protein_start,ref,alt,ref_aa,alt_aa,consequence_terms,ct,depth,maf)

imatD4=read.csv("data/Consensus_Data/novogene_lane15/sample_7/duplex/variant_caller_outputs/variants_unique_ann.csv")
# imatD2=merge_samples(imatD2,"Novogene_lane15/Sample4")
imatD4=imatD4%>%
  rowwise()%>%
  mutate(ref_aa=strsplit(amino_acids,"/")[[1]][1],
         alt_aa=strsplit(amino_acids,"/")[[1]][2])
imatD4=imatD4%>%mutate(maf=ct/depth)
imatD4_simple=imatD4%>%dplyr::select(alt_start_pos,protein_start,ref,alt,ref_aa,alt_aa,consequence_terms,ct,depth,maf)
...
##########IL3 Day 4 vs Imat D0############
il3D0.D4=merge(il3D0_simple%>%filter(consequence_terms%in%"missense_variant"),il3D4_simple%>%filter(consequence_terms%in%"missense_variant"),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),all.x = T)
il3D0.D4[il3D0.D4$ct.y%in%NA,"ct.y"]=0
il3D0.D4=il3D0.D4%>%mutate(score=log2(maf.y/maf.x))
il3D0.D4[il3D0.D4$score%in%NA,"score"]=-6
...
####Plotting Imatinib D4 D2 scores vs Imatinib D2 D0 scores
#First merging IL3 D0 D2 to IL3 D2 D4
scores_all=merge(il3D0.D2%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),il3D2.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),suffixes = c(".il3d0.d2",".il3d2.d4"),all.x = T)
#Second, adding Imat D0 D2 to dataframe
scores_all=merge(scores_all,imatD0.D2%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),all.x = T)
scores_all=scores_all%>%rename(score.imatd0.d2=score)
#Third, adding Imat D2 D4 to dataframe
scores_all=merge(scores_all,imatD2.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),all.x = T)
scores_all=scores_all%>%rename(score.imatd2.d4=score)
#Fourth, adding IL3 D4 D0 to dataframe
scores_all=merge(scores_all,il3D0.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),all.x = T)
scores_all=scores_all%>%rename(score.il3d0.d4=score)
#Fifth, adding Imatinib D4 D0 to dataframe
scores_all=merge(scores_all,imatD0.D4%>%dplyr::select(-ct.x,-depth.x,-maf.x,-ct.y,-depth.y,-maf.y),by=c("ref_aa","protein_start","alt_aa","ref","alt","alt_start_pos","consequence_terms"),all.x = T)
scores_all=scores_all%>%rename(score.imatd0.d4=score)
