...
# seqdata_tsv_name="data/Consensus_Data/Novogene_lane13/sample1_2/sscs_sorted_filtered.tsv"
seqdata_tsv_name="data/Consensus_Data/Novogene_lane13/sample1/duplex/duplex_sorted_filtered.tsv"
# outdir="data/Consensus_data/Novogene_lane11/sample5/variant_caller_outputs"
outdir="data/Consensus_data/Novogene_lane13/sample1/duplex/variant_caller_outputs"
...
write.csv(calls_ann,paste(outdir,"/variants_ann.csv",sep = ""),row.names = F)
write.csv(calls_sum_merged,paste(outdir,"/variants_unique_ann.csv",sep = ""),row.names=F)
```
