...
author: "Haider Inam + Josh Reynolds"
date: '2022-12-20'
...
# JAR file location example: 
#   C:\Users\joshr\Documents\GitHub\duplex_sequencing_screen\data\Consensus_Data\Novogene_lane13\sample12

setwd("C:/Users/joshr/Documents/GitHub/duplex_sequencing_screen/")
getwd()
...
### Denote LANE and SAMPLE ###
#Duplex Samples

#seqdata_tsv_name=c("data/Consensus_data/Novogene_lane13_sample1/duplex/duplex_sorted_filtered.tsv.gz")

#### Lane 13 ####
seqdata_tsv_name=c("data/Consensus_data/Novogene_lane13/sample1/sscs/sscs_sorted_filtered.tsv.gz",
                   "data/Consensus_data/Novogene_lane13/sample1/duplex/dupex_sorted_filtered.tsv.gz",
                   "data/Consensus_data/novogene_lane13/sample2/sscs_sorted_filtered.tsv.gz",
                   "data/Consensus_data/novogene_lane13/sample3/sscs_sorted_filtered.tsv.gz",
                   "data/Consensus_data/novogene_lane13/sample4/sscs_sorted_filtered.tsv.gz",
                   "data/Consensus_data/novogene_lane13/sample5/sscs_sorted_filtered.tsv.gz",
                   "data/Consensus_data/novogene_lane13/sample6/sscs_sorted_filtered.tsv.gz")

outdir=c("data/Consensus_data/novogene_lane13/sample1/sscs/variant_caller_outputs/",
         "data/Consensus_data/Novogene_lane13/sample1/duplex/variant_caller_outputs/",
         "data/Consensus_data/novogene_lane13/sample2/variant_caller_outputs/",
         "data/Consensus_data/novogene_lane13/sample3/variant_caller_outputs/",
         "data/Consensus_data/novogene_lane13/sample4/variant_caller_outputs/",
         "data/Consensus_data/novogene_lane13/sample5/variant_caller_outputs/",
         "data/Consensus_data/novogene_lane13/sample6/variant_caller_outputs/")

#### Lane 14 ####
# seqdata_tsv_name=c("data/Consensus_data/Novogene_lane14/sample2_combined/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample3/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample4/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample5/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample6/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample7/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample8/sscs_sorted_filtered.tsv.gz")
# 
# outdir=c("data/Consensus_data/novogene_lane14/sample2_combined/variant_caller_outputs/",
#          "data/Consensus_data/novogene_lane14/sample3/variant_caller_outputs/",
#          "data/Consensus_data/novogene_lane14/sample4/variant_caller_outputs/",
#          "data/Consensus_data/novogene_lane14/sample5/variant_caller_outputs/",
#          "data/Consensus_data/novogene_lane14/sample6/variant_caller_outputs/",
#          "data/Consensus_data/novogene_lane14/sample7/variant_caller_outputs/",
#          "data/Consensus_data/novogene_lane14/sample7/variant_caller_outputs/")

#### Lane 15 ####
# seqdata_tsv_name=c("data/Consensus_data/Novogene_lane14/sample2/sscs/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample3/sscs/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample4/sscs/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample5/sscs/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample6/sscs/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample7/sscs/sscs_sorted_filtered.tsv.gz",
#                    "data/Consensus_data/novogene_lane14/sample8/sscs/sscs_sorted_filtered.tsv.gz")
# 
# outdir=c("data/Consensus_data/novogene_lane14/sample1/sscs/variant_caller_outputs/",
#                    "data/Consensus_data/novogene_lane14/sample2/sscs/variant_caller_outputs/",
#                    "data/Consensus_data/novogene_lane14/sample3/variant_caller_outputs/",
#                    "data/Consensus_data/novogene_lane14/sample4/variant_caller_outputs/",
#                    "data/Consensus_data/novogene_lane14/sample5/variant_caller_outputs/",
#                    "data/Consensus_data/novogene_lane14/sample6/variant_caller_outputs/")
...
# a=mnvs%>%filter(n_nuc%in%2,neighbordistance%in%1)
